  ...
  <footer class="footer center">
        <div class="footer__left">
            <div class="footer__logo">
                <svg class="footer__icon" width="34" height="34" viewBox="0 0 34 34" fill="none"
                ...
                <h2 class="footer__title">Interno</h2>
            </div>
            <p class="footer__text">It is a long established fact that a reader will be distracted lookings.</p>
            <div class="footer__media">
                <a href="#" class="footer__media-linkk"><svg class="footer__media-svg" width="19" height="16"
                ...
                <a href="#" class="footer__media-linkk"><svg class="footer__media-svg" width="17" height="16"
        ...
        <div class="footer__middle">
            ...
            <ul class="footer__nav-list">
                <li class="footer__nav-list-item"><router-link to="/" class="footer__nav-link">Home</router-link></li>
                <li class="footer__nav-list-item"><router-link to="/project" class="footer__nav-link">Project</router-link></li>
                <li class="footer__nav-list-item"><router-link to="/blog" class="footer__nav-link">Blog</router-link></li>
            </ul>
        </div>
        <div class="footer__absent-service"></div>
        <div class="footer__right">
            <p class="footer__contacts">Contact</p>
            <a href="https://www.google.com/maps/place/%D0%91%D1%80%D1%83%D0%BA%D0%BB%D0%B8%D0%BD,+%D0%9D%D1%8C%D1%8E-%D0%99%D0%BE%D1%80%D0%BA,+%D0%A1%D0%A8%D0%90/@40.6450861,-74.2564927,11z/data=!3m1!4b1!4m9!1m2!2m1!1s+Ave.+Brooklyn,+New+York+11201!3m5!1s0x89c24416947c2109:0x82765c7404007886!8m2!3d40.6781784!4d-73.9441579!16zL20vMGNyM2Q?entry=ttu"
                class="footer__address" title="Click to open a map">55 East Birchwood Ave. Brooklyn, New York 11201</a>
            <a href="mailto:contact@interno.com" class="footer__email"
                title="Click to send an email">contact@interno.com</a>
            <a href="tel:(123)4567890" class="footer__tel" title="Click to call">(123) 456 - 7890</a>
        </div>
    </footer>
</template>
